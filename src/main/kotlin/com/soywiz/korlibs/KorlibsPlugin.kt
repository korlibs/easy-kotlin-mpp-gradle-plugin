...
class KorlibsExtension(val project: Project, val nativeEnabled: Boolean, val androidEnabled: Boolean) {
	...
	val MACOS_IOS_WATCHOS_TARGETS = MACOS_DESKTOP_NATIVE_TARGETS + IOS_TARGETS + WATCHOS_TARGETS
	val MACOS_IOS_TVOS_TARGETS = MACOS_DESKTOP_NATIVE_TARGETS + IOS_TARGETS + TVOS_TARGETS
